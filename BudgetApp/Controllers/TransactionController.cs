...
namespace BudgetApp.Controllers
{
    public class TransactionController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Date,Amount,TransactionType")] Transaction transaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Date,Amount, TransactionType")] Transaction transaction)
        {
